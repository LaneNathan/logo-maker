...
test("should render a 300 x 200 svg element", () => {
  ...
  test("should include a shape", () => {
    const expectedSvg =
'<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg"><polygon points=/"150, 18 244, 182 56, 182" fill="yellow"/><text x="150" y="125" font-size="60" text-anchor="middle" fill="yellow">RZA</text></svg>';
    const svg = new SVG();
